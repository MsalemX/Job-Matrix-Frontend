...
class Profile {
  ...
  factory Profile.fromJson(Map<String, dynamic> json) {
    ...
    bool publicAct = true;
    if (json.containsKey('public_activity') && json['public_activity'] != null) {
      publicAct = json['public_activity'] == 1 || json['public_activity'] == true || json['public_activity'] == '1';
    }
